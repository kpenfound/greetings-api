...
// A unique identifier for an object.
type CodeWorkspaceCheckableID = ID

// A unique identifier for an object.
type CodeWorkspaceID = ID
...
// A unique identifier for an object.
type GithubIssueCommentID = ID

// A unique identifier for an object.
type GithubIssueDataID = ID

// A unique identifier for an object.
type GithubIssueID = ID

// A unique identifier for an object.
type GithubIssueTemplateID = ID
...
// Load a CodeWorkspaceCheckable from its ID.
func (r *Query) LoadCodeWorkspaceCheckableFromID(id CodeWorkspaceCheckableID) *CodeWorkspaceCheckable {
	q := r.query.Select("loadCodeWorkspaceCheckableFromID")
	q = q.Arg("id", id)
...
// Load a CodeWorkspace from its ID.
func (r *Query) LoadCodeWorkspaceFromID(id CodeWorkspaceID) *CodeWorkspace {
	q := r.query.Select("loadCodeWorkspaceFromID")
	q = q.Arg("id", id)
...
func (r *Query) LoadGithubIssueCommentFromID(id GithubIssueCommentID) *GithubIssueComment {
...
func (r *Query) LoadGithubIssueDataFromID(id GithubIssueDataID) *GithubIssueData {
...
func (r *Query) LoadGithubIssueFromID(id GithubIssueID) *GithubIssue {
...
func (r *Query) LoadGithubIssueTemplateFromID(id GithubIssueTemplateID) *GithubIssueTemplate {
