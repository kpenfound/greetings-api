...
import (
	...
	dagger "github.com/kpenfound/greetings-api/.dagger/internal/dagger/clients/frontend"
)
...
func Frontend(opts ...dagger.FrontendOpts) *dagger.Frontend {
	client := initClient()
	return client.Frontend(opts...)
}
...
func LoadFrontendFromID(id dagger.FrontendID) *dagger.Frontend {
	client := initClient()
	return client.LoadFrontendFromID(id)
}
