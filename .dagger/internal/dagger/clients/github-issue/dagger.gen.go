...
func serveBoundModule(ctx context.Context, client *Client) error {
	return client.
		ModuleSource("github.com/kpenfound/dag/github-issue@2b76331a92be6da3fead95305e7bf2a70726c1e6", ModuleSourceOpts{RefPin: "2b76331a92be6da3fead95305e7bf2a70726c1e6"}).
		AsModule().
		Serve(ctx)
}
