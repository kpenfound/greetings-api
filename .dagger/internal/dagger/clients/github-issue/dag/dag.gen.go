...
import (
	...
	dagger "github.com/kpenfound/greetings-api/.dagger/internal/dagger/clients/github-issue"
)
...
func GithubIssue(opts ...dagger.GithubIssueOpts) *dagger.GithubIssue {
	client := initClient()
	return client.GithubIssue(opts...)
}
...
func LoadGithubIssueCommentFromID(id dagger.GithubIssueCommentID) *dagger.GithubIssueComment {
	client := initClient()
	return client.LoadGithubIssueCommentFromID(id)
}

// Load a GithubIssueData from its ID.
func LoadGithubIssueDataFromID(id dagger.GithubIssueDataID) *dagger.GithubIssueData {
	client := initClient()
	return client.LoadGithubIssueDataFromID(id)
}

// Load a GithubIssue from its ID.
func LoadGithubIssueFromID(id dagger.GithubIssueID) *dagger.GithubIssue {
	client := initClient()
	return client.LoadGithubIssueFromID(id)
}

// Load a GithubIssueTemplate from its ID.
func LoadGithubIssueTemplateFromID(id dagger.GithubIssueTemplateID) *dagger.GithubIssueTemplate {
	client := initClient()
	return client.LoadGithubIssueTemplateFromID(id)
}
