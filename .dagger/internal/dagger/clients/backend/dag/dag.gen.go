...
import (
	...
	dagger "github.com/kpenfound/greetings-api/.dagger/internal/dagger/clients/backend"
)
...
func Backend(opts ...dagger.BackendOpts) *dagger.Backend {
	client := initClient()
	return client.Backend(opts...)
}
...
func LoadBackendFromID(id dagger.BackendID) *dagger.Backend {
	client := initClient()
	return client.LoadBackendFromID(id)
}
