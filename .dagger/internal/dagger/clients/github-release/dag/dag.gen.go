...
import (
	...
	dagger "github.com/kpenfound/greetings-api/.dagger/internal/dagger/clients/github-release"
)
...
func GithubRelease() *dagger.GithubRelease {
	client := initClient()
...
func LoadGithubReleaseFromID(id dagger.GithubReleaseID) *dagger.GithubRelease {
	client := initClient()
	return client.LoadGithubReleaseFromID(id)
}
...
func Pipeline(name string, opts ...dagger.PipelineOpts) *dagger.Query {
	client := initClient()
