...
import (
	...
	dagger "backend/internal/dagger/clients/go"
...
func LoadGoDirectoryFromID(id dagger.GoDirectoryID) *dagger.GoDirectory {
	client := initClient()
	return client.LoadGoDirectoryFromID(id)
}
...
func LoadGoModuleFromID(id dagger.GoModuleID) *dagger.GoModule {
	client := initClient()
	return client.LoadGoModuleFromID(id)
}
